...
class TestDDOps {
	...
	void setUp() throws Exception {
		...
		LOGGER = LogManager.getLogger(TestDDOps.class);
	...
	public void testDDIndependentMult() {
		...
		DDTree f1 = ddMaker.getDDTreeFromSequence(new String[] { "EXFIL_ONGOING", "HAS_C_DATA", "EXFIL_ONGOING'" },
				new String[][] { { "no", "no", "yes", "1.0" }, { "no", "yes", "no", "1.0" },
						{ "yes", "yes", "yes", "1.0" }, { "yes", "no", "yes", "1.0" }, });

		DD f1dd = OP.reorder(f1.toDD());

		LOGGER.debug("f1 is " + f1dd.toDDTree());

		DDTree f2 = ddMaker.getDDTreeFromSequence(new String[] { "EXFIL_ONGOING", "HAS_FAKE_DATA", "EXFIL_ONGOING'" },
				new String[][] { { "yes", "no", "yes", "1.0" }, { "yes", "yes", "no", "1.0" },
						{ "no", "yes", "no", "1.0" }, { "no", "no", "no", "1.0" }, });
...
//				+ "exfil.6S.L0.obs_deception.domain";
		...
		String domain = "/home/adityas/UGA/THINCLab/DomainFiles/final_domains/" + "exfil.6S.L0.obs_deception.domain";
	...
	public void testDDCreationBenchmarks() {
		...
		LOGGER.info("Global Nodes Caches contains: " + (Global.nodeHashtable.size() + Global.leafHashtable.size())
				+ " nodes.");
		...
		DD b = ddMaker.getDDTreeFromSequence(new String[] { "A", "B" },
				new String[][] { { "a1", "b1", "1.0" }, { "a1", "b2", "0.0" }, { "a1", "b3", "0.0" },
						{ "a2", "b1", "0.33" }, { "a2", "b2", "0.33" }, { "a2", "b3", "0.34" } })
				.toDD();
		...
		DD c = ddMaker.getDDTreeFromSequence(new String[] { "A", "B", "C" },
				new String[][] { { "a1", "b1", "c1", "0.5" }, { "a1", "b1", "c2", "0.5" }, { "a1", "b2", "c1", "0.33" },
						{ "a1", "b2", "c2", "0.67" }, { "a1", "b3", "c1", "0.25" }, { "a1", "b3", "c2", "0.75" },
						{ "a2", "b1", "c1", "1.0" }, { "a2", "b1", "c2", "0.0" }, { "a2", "b2", "c1", "0.0" },
						{ "a2", "b2", "c2", "1.0" }, { "a2", "b3", "c1", "1.0" }, { "a2", "b3", "c2", "0.0" } })
				.toDD();
	...
	public void testAdditionTimes() {
		...
		for (int i = 0; i < 10000; i++) {
			...
			DD c1 = ddMaker.getDDTreeFromSequence(new String[] { "A", "B", "C" },
					new String[][] { { "a1", "b1", "c1", "0.5" }, { "a1", "b1", "c2", "0.5" },
							{ "a1", "b2", "c1", "0.33" }, { "a1", "b2", "c2", "0.67" }, { "a1", "b3", "c1", "0.25" },
							{ "a1", "b3", "c2", "0.75" }, { "a2", "b1", "c1", "1.0" }, { "a2", "b1", "c2", "0.0" },
							{ "a2", "b2", "c1", "0.0" }, { "a2", "b2", "c2", "1.0" }, { "a2", "b3", "c1", "1.0" },
							{ "a2", "b3", "c2", "0.0" } })
					.toDD();

			DD c2 = ddMaker.getDDTreeFromSequence(new String[] { "A", "B", "C" },
					new String[][] { { "a1", "b1", "c1", "0.5" }, { "a1", "b1", "c2", "0.5" },
							{ "a1", "b2", "c1", "0.33" }, { "a1", "b2", "c2", "0.67" }, { "a1", "b3", "c1", "0.25" },
							{ "a1", "b3", "c2", "0.75" }, { "a2", "b1", "c1", "1.0" }, { "a2", "b1", "c2", "0.0" },
							{ "a2", "b2", "c1", "0.0" }, { "a2", "b2", "c2", "1.0" }, { "a2", "b3", "c1", "1.0" },
	...
	public void checkDifferentVariableOPs() {
		...
		DD a = ddMaker
				.getDDTreeFromSequence(new String[] { "A" }, new String[][] { { "a1", "1.509" }, { "a2", "0.789870" } })
				.toDD();

		DD b = ddMaker
				.getDDTreeFromSequence(new String[] { "C" }, new String[][] { { "c1", "2.8907" }, { "c2", "1.5" } })
				.toDD();
