...
public class PersistentStructuredTree extends StructuredTree implements Serializable {
	...
	private static final Logger LOGGER = LogManager.getLogger(PersistentStructuredTree.class);
...
//		System.out.println("Node is " + this.DB.getNode(id));
	...
	public List<String> getNodeLabels() {
		return this.DB.getAllNodeIds().stream().map(i -> "m" + i).collect(Collectors.toList());
	}
