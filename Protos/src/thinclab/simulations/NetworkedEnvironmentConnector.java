...
abstract public class NetworkedEnvironmentConnector implements ExternalEnvironmentConnector {
	...
	private static final Logger LOGGER = Logger.getLogger(NetworkedEnvironmentConnector.class);
	...
	public void createEnvStreams() throws Exception {
		...
		this.envInStream = 
				new BufferedReader(
						new InputStreamReader(this.envConnectorSocket.getInputStream()));
	...
	public String[] getObservation() {
		...
		if (observation == null) LOGGER.error("observation is null");
