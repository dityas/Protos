...
//    	}
//    	else {
////    		System.out.println("Printing for "+Global.varNames[var-1]);
//    	    System.out.print(space + Global.varNames[var-1] + "  "); //+ MySet.toString(varSet));
//    	}
//
//    	space = space + "{";
//    	if (Global.valNames == null) {
...
//    	else {
//    	    for (int i=0; i<children.length; i++) {
//    	    	System.out.println(children[i].var);
////    		children[i].display(space, Global.valNames[var-1][i] + ": ");
//    	    }
//    	}
//        }
...
//    	}
//    	else {
//    	    System.out.print(space + prefix + Global.varNames[var-1] + "  ");// + MySet.toString(varSet));
//    	}
//    
//    	space = space + "{";
//    	if (Global.valNames == null) {
