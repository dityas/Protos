 ...
 *
 */
public class CyberDeceptionSimulationWithHuman extends HumanAgentSimulation {
	...
	private static final Logger LOGGER = LogManager.getLogger(CyberDeceptionSimulationWithHuman.class);

	// ---------------------------------------------------------------------------------------------

	public CyberDeceptionSimulationWithHuman(BaseSolver ipomdpSolver, HumanAgentSolver humanSolver, int interactions,
			String envIP, int envPort) {

		super(ipomdpSolver, humanSolver, interactions);
